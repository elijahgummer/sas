    ...
    <div className="flex min-h-screen flex-col bg-white dark:bg-gray-900 subtle-pattern">
      ...
      >
        <div className="container flex h-20 items-center justify-between">
          ...
          {/* Mobile menu */}
          <div
            className={`fixed inset-0 z-40 bg-white/95 dark:bg-gray-900/95 md:hidden flex flex-col items-center justify-center gap-8 transition-all duration-300 ${isMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"}`}
          >
            <Link
              href="#features"
